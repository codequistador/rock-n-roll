...
import moduleForAcceptance from 'rock-n-roll/tests/helpers/module-for-acceptance';
...
test('Sort songs in various ways', function(assert) {
  ...
  andThen(function() {
    ...
    assertTrimmedText(assert, '.song:first', 'Elephants', 'The first song is highest ranked, first in the alphabet');
    assertTrimmedText(assert, '.song:last', 'New Fang', 'The last song is lowest ranked, last in the alphabet');
  });
